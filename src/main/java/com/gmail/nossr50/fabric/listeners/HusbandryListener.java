...
public final class HusbandryListener {
     ...
     * jar-confirmed on both of this band's versions — so hooking the harvest itself would have paid an
     * AFK brush farm. Hooking {@code interactMob}, which the dispenser never enters, keeps that
     * exclusion structural instead of turning it into a check of our own that could rot.
