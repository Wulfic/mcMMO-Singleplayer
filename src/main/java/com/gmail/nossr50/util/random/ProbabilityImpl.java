...
public class ProbabilityImpl implements Probability {
    ...
    @Override
    public int hashCode() {
        // PORT: legacy used com.google.common.base.Objects.hashCode; swapped to java.util.Objects
        // to avoid a Guava dependency on the util layer. Behaviourally identical for a single double.
