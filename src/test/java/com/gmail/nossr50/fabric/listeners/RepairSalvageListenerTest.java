...
class RepairSalvageListenerTest {
    ...
    void clientSideFireOnTheRepairAnvilPassesWhenNoWorldSessionEverLoadedTheConfigs() {
        ...
        final InteractionResult result = assertDoesNotThrow(
                () -> RepairSalvageListener.onUseBlock(clientPlayer(damagedChestplate()), world,
                        InteractionHand.MAIN_HAND, anvilHit()),
    ...
    void theSameClickIsStillClaimedOnceAWorldSessionHasLoadedTheConfigs() {
        ...
        final InteractionResult result = RepairSalvageListener.onUseBlock(
                clientPlayer(damagedChestplate()), world, InteractionHand.MAIN_HAND, anvilHit());
