...
| `/mcstats <skill> keep` | Toggle a running chat readout of that skill's XP gains, **totalled and printed once every 5 seconds** rather than one line per gain. Run it again to stop. Not remembered across a restart. |
